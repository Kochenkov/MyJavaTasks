 ...
 *
 * -- ОБОСНОВАНИЕ КОРРЕКТНОСТ РАБОТЫ --
 * Подумал, что для тех методов и условий, которые были описаны в задаче, динамического массива будет достаточно.
 * Если бы дэк требовался большего размера, то стоило-бы применить двусвязный список, тк он эффективнее для удаления и добавления элементов в начало списка
 * и при этом переодически не пересоздается при увеличении размера, как динамический массив.
 *
 * -- ВРЕМЕННАЯ СЛОЖНОСТЬ --
